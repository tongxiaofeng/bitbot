...
const (
	OKCOIN_API_URL_INTERNATIONAL   = "https://www.okcoin.com/api/v1/"
	...
	OKCOIN_MIN_FEE_BTC = 0.01
	OKCOIN_MIN_FEE_LTC = 0.1
	//OKCOIN_MIN_FEE_CNY =
)
...
type OKCoinTrades struct {
	...
	Type    string  `json:"type"` //"sell" or "buy"
}

func (o *OKCoin) SetDefaults() {
	o.SetErrorDefaults()
	o.Enabled = false
	o.RESTPollingDelay = 10000
	o.FuturesValues = []string{"this_week", "next_week", "quarter"}

	if !okcoinDefaultsSet {
		o.APIUrl = OKCOIN_API_URL_INTERNATIONAL
...
func (o *OKCoin) Setup(exconfig ExchangeConfig) {
	if !exconfig.Enabled {
		o.SetEnabled(false)
	} else {
		o.Enabled = true
...
func (o *OKCoin) GetFee(maker bool) float64 {
	if o.APIUrl == OKCOIN_API_URL_INTERNATIONAL {
		if maker {
			return o.MakerFee
		} else {
			return o.TakerFee
...
func (o *OKCoin) Run() {
	if verbose {
		log.Printf("%s polling delay: %ds.\n", o.GetName(), o.RESTPollingDelay, " ms.")
	...
	for o.Enabled {
		...
		time.Sleep(time.Millisecond * o.RESTPollingDelay)
	}
}
...
size :value: 1-200
merge :value: 1, 0.1（合并深度）
*/
func (o *OKCoin) GetDepth(symbol string, size int64, merge bool) (OKCoinDepth, error) {
	resp := OKCoinDepth{}
	vals := url.Values{}
	vals.Set("symbol", symbol)
	if size != 0 {
...
*/
func (o *OKCoin) GetRecords(symbol, klineType string, size, since int64) ([]interface{}, error) {
	resp := []interface{}{}
	vals := url.Values{}
	vals.Set("symbol", symbol)
...
func (o *OKCoin) GetFuturesDepth(symbol, contractType string, size int64, merge bool) (OKCoinDepth, error) {
	result := OKCoinDepth{}
	vals := url.Values{}
	vals.Set("symbol", symbol)
	vals.Set("contract_type", contractType)
...
func (o *OKCoin) GetFutureRecords(symbol, klineType, contractType string, size, since int64) ([]interface{}, error) {
	resp := []interface{}{}
	vals := url.Values{}
	vals.Set("symbol", symbol)
	vals.Set("type", klineType)
...
func (o *OKCoin) LimitBuy(amount, price float64) (int, error) {
	return 0, nil
}

func (o *OKCoin) LimitSell(amount, price float64) (int, error) {
	return 0, nil
}

func (o *OKCoin) MarketBuy(amount float64) (int, error) {
	return 0, nil
}

func (o *OKCoin) MarketSell(amount float64) (int, error) {
	return 0, nil
}
...
//GetAccount : Retrieves balances for all enabled currencies for the OKCoin exchange
func (e *OKCoin) GetAccount() (ExchangeAccountInfo, error) {
...
//TODO https://www.okcoin.com/about/rest_request.do
