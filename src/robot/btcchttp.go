...
func (b *BTCCExchange) Setup(exch ExchangeConfig) {
	b.RESTPollingDelay = exch.RESTPollingDelay
	b.BaseCurrencies = SplitStrings(exch.BaseCurrencies, ",")
	b.AvailablePairs = SplitStrings(exch.AvailablePairs, ",")
}

func (b *BTCCExchange) GetAvailablePairs() []string {
	return b.AvailablePairs
}

//Start is run if exchange is enabled, after Setup
func (b *BTCCExchange) Start() {
	//go b.Run()
}

func (b *BTCCExchange) GetName() string {
	return b.Name
}
...
func (b *BTCCExchange) GetTicker(symbol string) BTCCTicker {
...
func (b *BTCCExchange) GetTradesLast24h(symbol string) bool {
...
func (b *BTCCExchange) GetTradeHistory(symbol string, limit, sinceTid int64, time time.Time) bool {
...
func (b *BTCCExchange) GetOrderBook(symbol string, limit int) bool {
...
func (b *BTCCExchange) GetAccountInfo(infoType string) {
...
func (b *BTCCExchange) PlaceOrder(buyOrder bool, price, amount float64, market string) {
	params := make([]interface{}, 0)
...
func (b *BTCCExchange) CancelOrder(orderID int64, market string) {
	params := make([]interface{}, 0)
...
func (b *BTCCExchange) GetDeposits(currency string, pending bool) {
	params := make([]interface{}, 0)
...
func (b *BTCCExchange) GetMarketDepth(market string, limit int64) {
	params := make([]interface{}, 0)
...
func (b *BTCCExchange) GetOrder(orderID int64, market string, detailed bool) {
	params := make([]interface{}, 0)
	params = append(params, orderID)
...
func (b *BTCCExchange) GetOrders(openonly bool, market string, limit, offset, since int64, detailed bool) {
	params := make([]interface{}, 0)
...
func (b *BTCCExchange) GetTransactions(transType string, limit, offset, since int64, sinceType string) {
	params := make([]interface{}, 0)
...
func (b *BTCCExchange) GetWithdrawal(withdrawalID int64, currency string) {
	params := make([]interface{}, 0)
...
func (b *BTCCExchange) GetWithdrawals(currency string, pending bool) {
	params := make([]interface{}, 0)
	params = append(params, currency)
...
func (b *BTCCExchange) RequestWithdrawal(currency string, amount float64) {
	params := make([]interface{}, 0)
	params = append(params, currency)
...
func (b *BTCCExchange) IcebergOrder(buyOrder bool, price, amount, discAmount, variance float64, market string) {
	params := make([]interface{}, 0)
	params = append(params, strconv.FormatFloat(price, 'f', -1, 64))
	params = append(params, strconv.FormatFloat(amount, 'f', -1, 64))
...
func (b *BTCCExchange) GetIcebergOrder(orderID int64, market string) {
	params := make([]interface{}, 0)
	params = append(params, orderID)
...
func (b *BTCCExchange) GetIcebergOrders(limit, offset int64, market string) {
	params := make([]interface{}, 0)
...
func (b *BTCCExchange) CancelIcebergOrder(orderID int64, market string) {
	params := make([]interface{}, 0)
	params = append(params, orderID)
...
func (b *BTCCExchange) PlaceStopOrder(buyOder bool, stopPrice, price, amount, trailingAmt, trailingPct float64, market string) {
	params := make([]interface{}, 0)
...
func (b *BTCCExchange) GetStopOrder(orderID int64, market string) {
	params := make([]interface{}, 0)
	params = append(params, orderID)
...
func (b *BTCCExchange) GetStopOrders(status, orderType string, stopPrice float64, limit, offset int64, market string) {
	params := make([]interface{}, 0)
...
func (b *BTCCExchange) CancelStopOrder(orderID int64, market string) {
	params := make([]interface{}, 0)
	params = append(params, orderID)
...
func (b *BTCCExchange) SendAuthenticatedHTTPRequest(method string, params []interface{}) (err error) {
