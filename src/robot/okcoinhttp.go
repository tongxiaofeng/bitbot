...
func (o *OKCoin) Setup(exconfig ExchangeAPI) {
	if !exconfig.Enabled {
		o.SetEnabled(false)
	} else {
		o.Enabled = true
		o.AuthenticatedAPISupport = exconfig.AuthenticatedAPISupport
		o.SetAPIKeys(exconfig.APIKey, exconfig.APISecret)
		o.RESTPollingDelay = exconfig.RESTPollingDelay
		o.Verbose = exconfig.Verbose
		o.BaseCurrencies = SplitStrings(exconfig.BaseCurrencies, ",")
		o.AvailablePairs = SplitStrings(exconfig.AvailablePairs, ",")
		o.EnabledPairs = SplitStrings(exconfig.EnabledPairs, ",")
	}
}
